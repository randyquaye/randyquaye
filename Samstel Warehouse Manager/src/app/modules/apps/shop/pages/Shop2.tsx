            ...
            <div className="card card-custom h-100">
              <div className="card-body d-flex flex-column rounded bg-light justify-content-between">
                <div className="text-center rounded mb-7">
                  <img
                    src={toAbsoluteUrl("/media/products/15.png")}
                    className="mw-100 w-200px"
                    alt="img"
                  />
                </div>
          ...
          <div className="col-md-4 col-lg-12 col-xxl-4">
            <div className="card card-custom h-100">
              <div className="card-body d-flex flex-column rounded bg-light   justify-content-between">
                <div className="text-center rounded mb-7">
                  <img
                    src={toAbsoluteUrl("/media/products/16.png")}
                    className="mw-100 w-200px"
                    alt="img"
                  />
                </div>
          ...
          <div className="col-md-4 col-lg-12 col-xxl-4">
            <div className="card card-custom h-100">
              <div className="card-body d-flex flex-column rounded bg-light   justify-content-between">
                <div className="text-center rounded mb-7">
                  <img
                    src={toAbsoluteUrl("/media/products/17.png")}
                    className="mw-100 w-200px"
                    alt="img"
                  />
                </div>
          ...
          <div className="col-md-4 col-lg-12 col-xxl-4">
            <div className="card card-custom h-100">
              <div className="card-body d-flex flex-column rounded bg-light   justify-content-between">
                <div className="text-center rounded mb-7">
                  <img
                    src={toAbsoluteUrl("/media/products/18.png")}
                    className="mw-100 w-200px"
                    alt="img"
                  />
                </div>
