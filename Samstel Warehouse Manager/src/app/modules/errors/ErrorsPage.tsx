...
const ErrorsPage: React.FC = () => {
  return (
    ...
    >
      {/* begin::Background */}
      <div
        className="bgi-size-contain bgi-position-x-end bgi-position-y-center bgi-no-repeat position-absolute top-0 start-0 w-100 h-100 d-none d-lg-block"
        style={{
      ...
      <div
        className="bgi-size-contain bgi-position-y-bottom bgi-position-x-end bgi-no-repeat position-absolute top-0 start-0 w-100 h-100 d-lg-none"
        style={{
          backgroundImage: `url('${toAbsoluteUrl(
            "/media/ssvg/illustrations/phone404.svg"
          )}')`,
        }}
      ></div>
      {/* end::Background */}
